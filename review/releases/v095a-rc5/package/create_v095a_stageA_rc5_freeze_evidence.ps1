...
$Rel = "pipeline_v0.2.0/research/prospective_freezes/v095a_stageA_aggregate_inventory_rc5"
...
$Dest = Join-Path $ProjectRoot "work\v095a_stageA_rc5_freeze_evidence.json"
$Evidence | ConvertTo-Json -Depth 5 | Set-Content $Dest -Encoding UTF8
Write-Host "v095a RC5 FREEZE EVIDENCE PASS"
