...
EXPOSURE_CENSUS = BASE / "order01_queryexps_exposure_census_v028.csv"
PS1_TRIAGE = BASE / "order01_ps1_static_triage_v028.csv"
CATALOG_REC_REPORT = BASE / "order01_dasch_catalog_recurrence_report_v028.json"
INJ_REPORT = BASE / "order01_injection_recovery_report_v028.json"

MANIFEST = BASE / "order01_platephot_stage1_manifest_v028.csv"
POLICY = BASE / "order01_platephot_stage1_policy_v028.json"
DETAIL = BASE / "order01_platephot_stage1_detail_v028.csv"
PLATE_SUMMARY = BASE / "order01_platephot_stage1_plate_summary_v028.csv"
RANK_SUMMARY = BASE / "order01_platephot_stage1_rank_summary_v028.csv"
REPORT = BASE / "order01_platephot_stage1_report_v028.json"
...
UA = "historical-transient-pipeline/0.2.8-order01-platephot-stage1"
...
def main():
    ...
    print("=" * 104)
    print("ORDER 01 — SURVIVOR-DRIVEN DASCH INDEPENDENT-PLATE RECURRENCE: FIXED STAGE 1 v028")
    print("=" * 104)
    print(
    ...
    if not RANKS:
        ...
        policy_obj = {
            "analysis_kind": "order01_platephot_recurrence_stage1_fixed_v028",
            "active_ranks": [],
            "reason_no_calls": (
        ...
        report = {
            ...
            "analysis_kind": "order01_platephot_recurrence_stage1_v028",
            "guards": guards,
