...
OUT_PAIR = BASE / "order01_dasch_catalog_recurrence_triage_v028b.csv"
OUT_SOURCES = BASE / "order01_dasch_catalog_recurrence_sources_v028b.csv"
OUT_LC = BASE / "order01_dasch_catalog_recurrence_lightcurves_v028b.csv"
OUT_REPORT = BASE / "order01_dasch_catalog_recurrence_report_v028b.json"
OUT_UNUSABLE = BASE / "order01_dasch_catalog_recurrence_unusable_querycat_rows_v028b.csv"
...
UA = "historical-transient-pipeline/0.2.8-order01-dasch-recurrence-v028b"
...
def main():
    print("=" * 92)
    print("ORDER 01 — DASCH DR7 CATALOGUED HISTORICAL RECURRENCE SCREEN v028b")
    print("=" * 92)
    print(
    ...
    out_report = {
        "status": "COMPLETE",
        "analysis_kind": "order01_dasch_dr7_catalogued_historical_recurrence_v028b",
        "api_base": API_BASE,
        "guards": guards,
