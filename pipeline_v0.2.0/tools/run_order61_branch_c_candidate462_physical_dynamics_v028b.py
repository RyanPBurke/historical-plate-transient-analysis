...
OUT = BASE / "order61_branch_c_candidate462_physical_dynamics_v028b.json"
OUT_STATES = BASE / "order61_branch_c_candidate462_velocity_states_v028b.csv"
...
def main():
    print("="*112)
    print("ORDER 61 — BRANCH C #20 / CANDIDATE 462 PHYSICAL-DYNAMICAL PLAUSIBILITY v028b")
    print("="*112)
    print(
    ...
    print(
        "Implementation amendment: offset-aware refined UTC timestamp is parsed via "
        "datetime.fromisoformat before Astropy Time; physical policy is unchanged."
    )
    print()
    ...
    sun_ang_radius_deg = math.degrees(math.asin(695700.0/float(np.linalg.norm(toSun))))
    ...
    report = {
        "status": "COMPLETE",
        "analysis_kind": "order61_branch_c_candidate462_physical_dynamical_plausibility_v028b",
        "guards": guards,
