...
def main():
    ...
    if args.workers not in (1,2):
        raise RuntimeError("REFUSING: v066 supports only 1 or 2 workers; default/frozen operational maximum is 2")
    ...
    print(f"Workers: {args.workers} | GLOBAL minimum request-start spacing: {GLOBAL_REQUEST_START_INTERVAL_S:.2f}s")
