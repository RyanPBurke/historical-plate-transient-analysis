...
def main():
    print("=" * 92)
    print("ORDER 61 — DASCH DR7 CATALOGUED HISTORICAL RECURRENCE SCREEN")
    print("=" * 92)
    print(
        "All 4 Gaia+PS1-clean ranks; ATLAS+APASS; verified HTTPS; "
    ...
    out_report = {
        "status": "COMPLETE",
        "analysis_kind": "order61_dasch_dr7_catalogued_historical_recurrence",
        "api_base": API_BASE,
        "guards": guards,
        "fixed_policy": {
            "refcats": REFCATS,
