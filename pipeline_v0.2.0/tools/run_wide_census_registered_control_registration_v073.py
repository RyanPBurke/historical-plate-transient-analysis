...
OUT = RESULTS / "wide_census_registered_control_registration_v073"

JOB_DIR = OUT / "jobs"
PAIR_DIR = OUT / "pairs"
STATE = OUT / "state_v073.json"
JOB_SUMMARY = OUT / "wide_census_registered_control_job_summary_v073.csv"
PAIR_OUT = OUT / "wide_census_registered_control_pair_summary_v073.csv"
GLOBAL_OUT = OUT / "wide_census_registered_control_global_summary_v073.csv"
REPORT_OUT = OUT / "wide_census_registered_control_registration_v073.json"
...
def load_pair_gaia(
    ...
    return gaia, {
        ...
        "unique_rows_before_motion_filter":
            int(before - duplicate_rows_removed),
...
def main():
    ...
    print(
        ...
        "OFFLINE GAIA REGISTRATION v073"
    )
    print("=" * 124)
    print(
    ...
    if not args.preflight_only:
        if (
            ...
            raise RuntimeError(
                "v073 output directory already contains "
    ...
    for pair_index in wanted_pairs:
        ...
        for n, job in enumerate(
            ...
            job_obj = {
                "status": "COMPLETE",
                "analysis_kind":
                    "wide_census_registered_control_job_v073",
                "script_sha256":
                    script_sha,
        ...
        atomic_json(
            PAIR_DIR
            / f"pair_{pair_index:02d}_summary_v073.json",
            pair_summary,
        )
    ...
    if args.pair is not None:
        ...
        print(
            f"Total v073 job products currently present: "
    ...
    report = {
        "status": "COMPLETE",
        "analysis_kind":
            "wide_census_registered_control_registration_v073",
        "script_sha256":
            script_sha,
        "control_contract_sha256":
            EXPECTED_SHA[
    ...
    print("=" * 124)
    print(
        "v073 REGISTERED-CONTROL REGISTRATION COMPLETE"
    )
    print("=" * 124)
    print(
        f"Control jobs:                         "
