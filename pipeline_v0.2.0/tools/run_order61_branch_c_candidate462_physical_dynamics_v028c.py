...
OUT = BASE / "order61_branch_c_candidate462_physical_dynamics_v028c.json"
OUT_STATES = BASE / "order61_branch_c_candidate462_velocity_states_v028c.csv"
...
def main():
    print("="*112)
    print("ORDER 61 — BRANCH C #20 / CANDIDATE 462 PHYSICAL-DYNAMICAL PLAUSIBILITY v028c")
    print("="*112)
    print(
    ...
    print(
        "Implementation amendments: offset-aware refined UTC timestamp is parsed via "
        "datetime.fromisoformat; solar vector is independently cross-checked at ~1 AU "
        "before illumination/reflection geometry. Physical policy is unchanged."
    )
    print()
    ...
    report = {
        "status": "COMPLETE",
        "analysis_kind": "order61_branch_c_candidate462_physical_dynamical_plausibility_v028c",
        "guards": guards,
