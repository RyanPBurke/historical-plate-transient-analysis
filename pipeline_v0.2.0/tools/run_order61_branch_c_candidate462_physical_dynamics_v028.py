...
OUT = BASE / "order61_branch_c_candidate462_physical_dynamics_v028.json"
OUT_STATES = BASE / "order61_branch_c_candidate462_velocity_states_v028.csv"
...
def main():
    print("="*112)
    print("ORDER 61 — BRANCH C #20 / CANDIDATE 462 PHYSICAL-DYNAMICAL PLAUSIBILITY v028")
    print("="*112)
    print(
    ...
    event_time = Time(hit["refined_best_time_utc"])
    ...
    report = {
        "status": "COMPLETE",
        "analysis_kind": "order61_branch_c_candidate462_physical_dynamical_plausibility_v028",
        "guards": guards,
