...
def run_one_tile(tile, endpoint, handle, method, contract_sha):
    ...
    meta = {
        ...
        "robust_sigma": float(det["sigma"]),
        "median_residual": float(det["median_residual"]),
...
def finalize(endpoints, tiles, pairs, method, contract_sha):
    ...
    for i, pair in enumerate(pairs, 1):
        ...
        summaries.append({
            ...
            "candidate_science_state": "RAW_COINCIDENCE_INVENTORY_ONLY",
        })
    ...
    report = {
        ...
        "interpretation": (
            ...
            "They require the frozen generic v002 astrometric/static-source/morphology/"
            "population/sensitivity adjudication. The 41 v052 geometry holds remain outside "
            "this execution denominator and are still unresolved, not negative."
        ),
        "next_stage": (
...
def main():
    print("=" * 132)
    print("WIDE CENSUS — DISK-BOUNDED RESUMABLE FROZEN DETECTOR EXECUTION v056")
    print("=" * 132)
