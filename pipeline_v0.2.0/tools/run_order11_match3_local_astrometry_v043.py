#!/usr/bin/env python3
"""Order 11 / raw match 3 — target-independent local Gaia astrometry v043.
...
OUT = ROOT / "results" / "order11_followup_match3_v043"
...
def midpoint_coord(a: SkyCoord, b: SkyCoord) -> SkyCoord:
    ...
    return SkyCoord(x=v[0], y=v[1], z=v[2], representation_type="cartesian", frame="icrs").icrs
    ...
    for attempt in range(1, attempts+1):
        req = urllib.request.Request(
            ...
            headers={
                ...
                "Accept": "text/csv,*/*",
                "User-Agent": "historical-transient-pipeline/order11-match3-local-astrometry-v043",
            },
        )
        try:
...
def main():
    print("="*120)
    print("ORDER 11 — MATCH 3 TARGET-INDEPENDENT LOCAL GAIA ASTROMETRY v043")
    print("="*120)
    ...
    if selected is None:
        ...
        write_csv(OUT / "order11_match3_local_reference_audit_v043.csv", refs, ref_fields)
        result = {
            "status": "COMPLETE",
            "analysis_kind": "order11_match3_target_independent_local_gaia_astrometry_v043",
        ...
        write_json(OUT / "order11_match3_local_astrometry_report_v043.json", result)
    ...
    write_csv(OUT / "order11_match3_local_reference_audit_v043.csv", refs, ref_fields)
    write_json(OUT / "order11_match3_local_astrometry_report_v043.json", {
        "status": "COMPLETE",
        "analysis_kind": "order11_match3_target_independent_local_gaia_astrometry_v043",
    ...
    print("Report:", OUT / "order11_match3_local_astrometry_report_v043.json")
    print("References:", OUT / "order11_match3_local_reference_audit_v043.csv")
