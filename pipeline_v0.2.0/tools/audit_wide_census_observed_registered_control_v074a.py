#!/usr/bin/env python3
"""
v074a — read-only upstream audit of observed v068a registrations versus
...
This stage:
  ...
  * reads frozen upstream products and writes only new v074a audit products

The 5-pair dominance set (13,14,28,29,30) predates v074a and was already
identified in the v062/v068a population work. It is not selected from the
v074a observed/control result.
"""
...
OUT = RESULTS / "wide_census_observed_registered_control_audit_v074a"
OUT_REPORT = OUT / "wide_census_observed_registered_control_audit_v074a.json"
OUT_PAIR = OUT / "wide_census_observed_registered_control_pair_comparison_v074a.csv"
OUT_GLOBAL = OUT / "wide_census_observed_registered_control_global_cells_v074a.csv"
OUT_GROUP = OUT / "wide_census_observed_registered_control_group_summary_v074a.csv"
...
def ratio(a, b):
    # v074a operational repair:
    # Undefined component rates are represented by None. A downstream
    # rate-ratio involving an undefined numerator or denominator is itself
    # undefined, not an error. No scientific threshold or count changes.
...
def main():
    print("=" * 124)
    print("WIDE CENSUS OBSERVED vs REGISTERED-CONTROL AUDIT v074a")
    print("=" * 124)
    ...
    report = {
        "status": "COMPLETE",
        "analysis_kind": "wide_census_observed_registered_control_audit_v074a",
        "input_sha256": {
        ...
        "preexisting_pair_stratification": {
            ...
            "source":
                "Pair set identified before v074a from the v062/v068a population "
                "structure; not selected using the v074a corrected-control outcome.",
            "groups": groups,
        },
        "guards": {
        ...
        "interpretation_boundary": (
            ...
            "not independent random replicates; v074a therefore reports no p-value "
    ...
    print()
    print("=" * 124)
    print("v074a OBSERVED vs REGISTERED-CONTROL AUDIT COMPLETE")
    print("=" * 124)
    print(
