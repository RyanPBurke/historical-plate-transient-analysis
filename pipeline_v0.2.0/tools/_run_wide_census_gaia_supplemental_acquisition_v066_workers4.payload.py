...
def main():
    ...
    if args.workers not in (1,2,3,4):
        raise RuntimeError("REFUSING: v066 supports only 1 to 4 workers; default remains 2 and operational maximum is 4")
    ...
    print(f"Workers: {args.workers} (default 2; max 4) | GLOBAL minimum request-start spacing: {GLOBAL_REQUEST_START_INTERVAL_S:.2f}s")
