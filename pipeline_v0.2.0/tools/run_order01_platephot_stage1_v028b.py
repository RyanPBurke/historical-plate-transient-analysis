...
EXPOSURE_CENSUS = BASE / "order01_queryexps_exposure_census_v028b.csv"
PS1_TRIAGE = BASE / "order01_ps1_static_triage_v028.csv"
CATALOG_REC_REPORT = BASE / "order01_dasch_catalog_recurrence_report_v028b.json"
INJ_REPORT = BASE / "order01_injection_recovery_report_v028.json"

MANIFEST = BASE / "order01_platephot_stage1_manifest_v028b.csv"
POLICY = BASE / "order01_platephot_stage1_policy_v028b.json"
DETAIL = BASE / "order01_platephot_stage1_detail_v028b.csv"
PLATE_SUMMARY = BASE / "order01_platephot_stage1_plate_summary_v028b.csv"
RANK_SUMMARY = BASE / "order01_platephot_stage1_rank_summary_v028b.csv"
REPORT = BASE / "order01_platephot_stage1_report_v028b.json"
...
UA = "historical-transient-pipeline/0.2.8-order01-platephot-stage1-v028b"
...
def main():
    ...
    print("=" * 104)
    print("ORDER 01 — SURVIVOR-DRIVEN DASCH INDEPENDENT-PLATE RECURRENCE: FIXED STAGE 1 v028b")
    print("=" * 104)
    print(
    ...
    guards = {
        ...
        "catalog_recurrence_kind_v028b": (
            ...
            == "order01_dasch_dr7_catalogued_historical_recurrence_v028b"
        ),
    ...
    if not RANKS:
        ...
        policy_obj = {
            "analysis_kind": "order01_platephot_recurrence_stage1_fixed_v028b",
            "active_ranks": [],
            "reason_no_calls": (
        ...
        report = {
            ...
            "analysis_kind": "order01_platephot_recurrence_stage1_v028b",
            "guards": guards,
