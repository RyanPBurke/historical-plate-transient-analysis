...
const db = new PGlite();
const sql = readFileSync(new URL('./v095a_stageA_queries_rc4.sql', import.meta.url), 'utf8');
...
console.log('Q2 RC4 empty-plate result:',JSON.stringify(empty));
...
console.log('Q2 RC4 empty plate all zero, populated multiplicity, old-query negative regression: PASS');
