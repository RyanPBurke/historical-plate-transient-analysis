...
import run_v095a_stageA_inventory_rc4 as runner
import v095a_jobs_rc4 as jobs
from v095a_runtime_rc4 import (ProjectLock, HTTPResponse, TransportFailure,
...
class LifecycleTests(unittest.TestCase):
    def setUp(self):
        ...
        self.work = self.project/'work/v095a_stageA_aggregate_inventory_rc4'
    ...
    def test_failed_validation_retains_bytes_hash_and_sticks(self):
        ...
        with self.assertRaises(SystemExit): self.run_batch()
        meta=self.meta();artifact=meta['attempts'][0]['artifacts'][0]
    ...
    def test_download_retry_reuses_completed_job(self):
        ...
        self.assertTrue(meta['attempts'][0]['artifacts'][0]['partial'])
    ...
    def test_http_error_result_body_is_retained(self):
        ...
        artifact=self.meta()['attempts'][0]['artifacts'][0]
